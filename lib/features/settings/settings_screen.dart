...
class _GeneralSettingsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ListTile(
          leading: Icon(Icons.archive_outlined, color: scheme.onBackground),
          title:
              Text('Archived Habits', style: TextStyle(color: scheme.onBackground)),
        ...
        ListTile(
          leading: Icon(Icons.color_lens_outlined, color: scheme.onBackground),
